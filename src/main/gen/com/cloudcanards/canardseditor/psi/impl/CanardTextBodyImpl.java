...
public class CanardTextBodyImpl extends ASTWrapperPsiElement implements CanardTextBody {

  public CanardTextBodyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CanardVisitor visitor) {
    visitor.visitTextBody(this);
  }
