...
public class CanardEmotionHandleImpl extends ASTWrapperPsiElement implements CanardEmotionHandle {

  public CanardEmotionHandleImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CanardVisitor visitor) {
    visitor.visitEmotionHandle(this);
  }
